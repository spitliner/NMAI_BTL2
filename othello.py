...
def runMenu():
    ...
    screen.create_text(250, 280, anchor="center", text="Player go 1st", font=("Consolas", 20), fill="#aaa")
    for i in range(3):
        # Background
    ...
    screen.create_text(250, 380, anchor="center", text="Player go 2nd", font=("Consolas", 20), fill="#aaa")
    for i in range(3):
        # Background
